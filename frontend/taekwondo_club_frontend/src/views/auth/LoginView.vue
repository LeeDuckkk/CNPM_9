      ...
      <div class="wrapper">
        <el-form
          ...
          <div class="inputForm">
            ...
            <input type="text" class="input" name="username" placeholder="Nhập tên đăng nhập của bạn" v-model="formLogin.email"></input>
          </div>
          ...
          <div class="inputForm">
            ...
            <input type="password" id="pass" class="input" name="password" placeholder="Nhập mật khẩu của bạn" v-model="formLogin.password">
            <label for="pass">
          ...
          <div class="flex-row">
            <div>
              <input type="checkbox" id="idCheckRemember">
              <label for="idCheckRemember">Nhớ mật khẩu </label>
            </div>
            <span class="span">
            <router-link
                type="primary"
...
import {putLocalStorage,} from '@/helper/LocalStorageHelper'
