    ...
    <div class="container_3d">
      <div class="wrapper">
        <el-form
          ...
          <div class="inputForm">
            <input type="text" class="input" placeholder="Nhập tên của bạn" name="name" required v-model="form.name" >
          </div>
          ...
          <div class="inputForm">
            <input type="text" class="input" placeholder="Nhập email của bạn" name="name" required v-model="form.email" >
          </div>
          ...
          <div class="inputForm">
            <input type="text" class="input" placeholder="Nhập số điện thoại của bạn" name="phoneNumber"  v-model="form.phoneNumber" required>
          </div>
          <div class="phone-validation"></div>

<!--          <div class="flex-column">-->
<!--            <label>Giới tính</label>-->
<!--          </div>-->
<!--          &lt;!&ndash; Gender selection &ndash;&gt;-->
...
<!--          </div>-->
          ...
          <div class="inputForm">
            <input type="text" class="input" placeholder="Nhập quê quán của bạn" name="birthPlace" v-model="form.birthPlace" required>
          </div>
          ...
          <div class="form-group">
            <input type="date" id="joinDate" name="joinDate" v-model="form.joinDate">
          </div>
          ...
          <div class="inputForm">
            ...
            <input type="text" class="input" placeholder="Nhập tên tài khoản của bạn" name="username" v-model="form.username" required>
          </div>
          ...
          <div class="inputForm">
            ...
            <input type="password" id="pass" class="input" name="password" placeholder="Nhập mật khẩu của bạn" v-model="form.password">
            <label for="pass">
              <svg id="matPass" viewBox="0 0 576 512" height="1em" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div class="inputForm">
            ...
            <input type="password" class="input"  placeholder="Nhập lại mật khẩu của bạn" name="confirmPassword" v-model="form.confirmPassword" required>
          </div>
          <div class="password-confirm-validation"></div>
          <button class="button-submit" type="submit">Đăng ký</button>
          <p class="p">Bạn đã có tài khoản ? <span class="span"><router-link
              type="primary"
              :to="Paths.LOGIN"
          >Đăng nhập
          </router-link></span>
...
.password-confirm-validation li {
  font-size: 12px; /* Adjust this value as needed */
}
